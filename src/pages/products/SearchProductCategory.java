...
/**
 *
 * Handles the search for a product by category.
 * This class is responsible for displaying the search form for the product category,
 ...
 * @version 1.0
 */
public class SearchProductCategory implements HttpHandler {
    /**
            ...
            try{
                ...
                out.write(
                    "<html>" +
                            ...
                            "   <h4 class=\" ml-6 text-2xl font-bold dark:text-white\">Search Product by Category</h4>"+
                            ...
                            "       <a href=\"/products/find\" class=\"text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-small rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800\">Find Product by Id</a>\n" +
                            "   </div>"+
                            "</div>"+
                            ///
                            "<form class=\"ml-6 mr-6\" method=\"get\" action=\"/products/processSearchProductByCategoryHandler\">\n" +
                            "  <div class=\"mb-6\">\n" +
                            "    <label for=\"search\" class=\"block mb-2 text-sm font-medium text-gray-900 dark:text-white\">Product Category</label>\n" +
